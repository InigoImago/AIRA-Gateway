...
- Enforced: `ruff`, `ruff format`, `mypy --strict`, `prettier`, and a coverage **floor** — not the
  ...
  | | gate | measured 2026-08-26 |
  | --- | --- | --- |
  | Python (`--cov-fail-under`) | **90%** | 95.92% |
  | Frontend statements | 90% | 93.15% |
  | Frontend branches | **92%** | 92.06% |
  | Frontend lines | 93% | 94.82% |
  | Frontend functions | 75% | 76.06% |
...
to notice. **645 properties** as of 2026-08-27; the figure is stated in `CLAUDE.md` and a test
