...
> Related: [`FRD-102`](FRD-102-use-case-attribution.md) (attribution from Keycloak groups),
> [`FRD-201`](FRD-201-rbac.md) (roles → Django groups), [`FRD-202`](FRD-202-usecase-crud.md)
