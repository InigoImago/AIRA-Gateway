...
**87 of 93 delivered.** Narrative history: [`../DEVLOG.md`](../DEVLOG.md). Decisions: [`../adr/`](../adr/README.md). Rules this project has paid for: [`../LESSONS.md`](../LESSONS.md).
...
| [625](FRD-625-privacy-notice.md) | The privacy notice, written from a register the schema is checked against | 6 | ✅ Done |
