...
MUTATIONS = [
    ...
    Mutation(
        "TC41",
        "levels declared with a ceiling and no table would all mean the same thing",
    ...
    Mutation(
        "TC39",
        "a thinking level outside the model's own envelope is refused where it is written",
        "management/backend/src/aira_management/apps/catalog/validation.py",
    ...
    Mutation(
        "TC40",
        "a budget for a level the model does not offer is dead configuration, and refused",
        "management/backend/src/aira_management/apps/catalog/validation.py",
